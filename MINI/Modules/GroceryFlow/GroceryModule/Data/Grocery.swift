...
let groceryItems = [
    Grocery(type: .fruit, items: [
        ...
        GroceryItem(image: "https://images.unsplash.com/photo-1587132137056-bfbf0166836e?q=80&w=1760&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", productName: "Banana", isSale: false),
    ...
    Grocery(type: .vegetable, items: [
        ...
        GroceryItem(image: "https://images.unsplash.com/photo-1576181256399-834e3b3a49bf?q=80&w=1750&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", productName: "Carrot", isSale: false),
        GroceryItem(image: "https://images.unsplash.com/photo-1587411768638-ec71f8e33b78?q=80&w=1760&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", productName: "Cucumber", isSale: false)
    ]),
    ...
    Grocery(type: .dairy, items: [
        GroceryItem(image: "https://images.unsplash.com/photo-1603576120227-14c2f2f612d5?q=80&w=1880&auto=format&fit=crop&ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjF9", productName: "Milk", isSale: false)
    ])
]
