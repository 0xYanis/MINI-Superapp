//
//  MINIColorExtension.swift
//  MINI
//
//  Created by Yan Rybkin on 19.06.2023.
//
...
extension UIColor {
    ...
    static var tintMINI = UIColor(hex: "#FB7700") // orange
    static var tint2MINI = UIColor(hex: "#2CAEE0") // light blue
}
